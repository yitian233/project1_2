...
public class mCameraActivity extends AppCompatActivity {
    ...
    private PermissionCallback permissionCallback = new PermissionCallback() {
        ...
        public boolean onRequestPermission() {
            ActivityCompat.requestPermissions(mCameraActivity.this,
        ...
        CameraThreadPool.execute(new Runnable() {
            ...
            public void run() {
                ...
                int initModelStatus = IDcardQualityProcess.getInstance()
                        .idcardQualityInit(mCameraActivity.this.getAssets(),
                                "models");
                if (authStatus != 0) {
        ...
        public void onPictureTaken(final Bitmap bitmap) {
            CameraThreadPool.execute(new Runnable() {
                ...
                public void run() {
                    ...
                    Intent intent = new Intent(mCameraActivity.this,Note_detail.class);
                    //intent.putExtra(com.baidu.ocr.ui.camera.CameraActivity.KEY_CONTENT_TYPE, contentType);
                    Bundle bundle=new Bundle();
                    bundle.putString("file_path",outputFile.toString());
